...
import com.example.mydatabaseapp.databinding.FragmentLoginBinding
...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        loginViewModel.errotoastUsername .observe(this, Observer { hasError->
            if(hasError==true){
                Toast.makeText(requireContext(), "Usuario não existe, por favor registre-se", Toast.LENGTH_SHORT).show()
        ...
        loginViewModel.errorToastInvalidPassword.observe(this, Observer { hasError->
            if(hasError==true){
                Toast.makeText(requireContext(), "Por favor confira sua senha", Toast.LENGTH_SHORT).show()
